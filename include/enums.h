...
#define DIGI_RET_CHOOSE_DIGITAMA (DIGI_RET_OK + 11)
...
#define DIGI_EVENT_MASK_POOP    0b00010000
#define DIGI_EVENT_MASK_SLEEPY  0b00100000
#define DIGI_EVENT_MASK_WOKE_UP 0b01000000
